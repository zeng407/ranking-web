...
<div class="mt-3">
    <a class="btn btn-outline-light btn-block text-dark border-secondary" href="{{route('auth.redirect.google')}}">
        <span class="social-logo-wrapper"><img class="social-logo" src="{{asset('storage/google-logo.svg')}}" alt="Google logo"></span>
        <span class="">{{__('Login & Register with Google')}}</span>
    </a>
</div>
