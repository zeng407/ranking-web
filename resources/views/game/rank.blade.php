  ...
  <rank inline-template
    ...
    <div class="container-fuild" v-cloak>
      <div class="row m-0">
        ...
        {{-- main part --}}
        <div id="rank-main-region" class="col-12 col-lg-8">
          @if (!$embed)
            ...
            @if (!$post->is_censored &&
              ...
              <div id="rank-togawa-ad-grid"
                ...
                <div class="rank-togawa-ad-slot" data-rank-togawa-slot="div-gpt-ad-togawa-300x250-2"
                  style="display: none;">
                  @include('ads.gam_togawa_300x250', [
                ...
                <div class="rank-togawa-ad-slot" data-rank-togawa-slot="div-gpt-ad-togawa-300x250-3"
                  style="display: none;">
                  @include('ads.gam_togawa_300x250', [
                            ...
                            <div class="card-body p-0">
                              ...
                              <div class="card-body text-center rank-card">
                                <youtube-player
                                  ...
                                  width="100%" :ref-id="result.element.id.toString()"
                                  :video-id="result.element.video_id" :controls="true" :autoplay="false"
                                  :rel="0" origin="{{ request()->getSchemeAndHttpHost() }}">
                                </youtube-player>

                                <youtube-embed
                                  v-else-if="result.element.type === 'video' && result.element.video_source === 'youtube_embed'"
                                ...
                                <bilibili-video
                                  ...
                                  width="100%" height="400" :element="result.element" :autoplay="false"
                                  :muted="false" :preview="true">
                                </bilibili-video>
                                ...
                                <iframe
                                  ...
                                  :src="'https://clips.twitch.tv/embed?clip=' + result.element.video_id +
                                      '&parent=' + requestHost + ' & autoplay = false '"
                                  width="100%" allowfullscreen>
                                </iframe>

                                <video v-else-if="result.element.type === 'video'" width="100%" loop controls
                                  playsinline :src="result.element.source_url" :poster="result.element.thumb_url">
                                </video>

                                <viewer v-else-if="result.element.type === 'image'">
                                  <flex-image :options="viewerOptions" class="w-auto mw-100 cursor-pointer"
                                    :key="result.element.id" :image-key="result.element.id"
                                    :element-id="result.element.id" :imgur-url="result.element.imgur_url"
                                    ...
                                    :alt="result.element.title"></flex-image>
                                </viewer>
                              </div>
                            </div>
                          </div>
                ...
                <div class="container game-room-box bg-secondary text-white" style="max-width: 640px">
                  ...
                  <div class="p-1 my-1 game-room-container">
                    <div class="d-flex justify-content-between p-2">
                      ...
                      <span>積分
                        <i class="fa-solid fa-circle-question" data-toggle="tooltip" data-placement="top"
                          data-html="true" title="預測正確:連勝*10分<br>預測失敗:-10分"></i>
                      </span>
                    </div>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
                          ...
                          <div class="d-flex">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="reportDropdown">
                                <a class="dropdown-item" @click.prevent="reportComment(comment)" href="#"><i
                    ...
                    <div class="ml-auto">
                      <div class="text-align-end">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="reportDropdown">
                            <a class="dropdown-item" href="#" @click.prevent="reportComment(comment)"><i
                                class="fa-solid fa-triangle-exclamation"></i>&nbsp;{{ __('comment.report') }}</a>
                          </div>
                        </div>
                      </div>
              ...
              <b-pagination v-if="meta.last_page > 1" v-model="meta.current_page" :total-rows="meta.total"
                :per-page="meta.per_page" @input="changePage" class="justify-content-center"></b-pagination>
            </div>
            ...
            <div class="card-body">
              <div class="row">
                ...
                {{-- submit --}}
                <div class="col-12">
                  <button type="button" class="btn btn-primary" :disabled="!validComment || isSubmiting"
        ...
        {{-- return to top --}}
        <div v-if="showReturnUpButton" class="align-content-center rank-return-top-button">
