                ...
                <div class="row mb-3">
                    <div class="col-auto">
                        ...
                        <div class="m-1 d-inline-block">
                          <share-link id="rank" :url="shareRankLink()" text="{{__('rank.share')}}" after-copy-text="{{__('Copied link')}}"></share-link>
                        </div>
                        @if($gameResult && !$shared)
                          <div class="m-1 d-inline-block">
                            <share-link id="result" :url="shareResultLink()" text="{{__('rank.share-result')}}" after-copy-text="{{__('Copied link')}}" custom-class="btn btn-primary btn-sm"></share-link>
                          </div>
                        @endif
                    </div>
                </div>
