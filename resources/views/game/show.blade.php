          ...
          <div class="col-sm-12 col-md-6 pr-md-1 mb-2 mb-md-0">
            <div class="card game-player left-player" id="left-player">
              ...
              <div v-else-if="isVideoSource(le) && !isDataLoading" class="d-flex">
                ...
                <video @mouseover="videoHoverIn(le, re, true)" id="left-video-player" v-else width="100%" :height="elementHeight" loop autoplay controls playsinline :src="le.source_url"></video>
              </div>
          ...
          <div class="col-sm-12 col-md-6 pl-md-1 mb-4 mb-md-0">
            <div class="card game-player right-player" :class="{ 'flex-column-reverse': isMobileScreen, 'mb-4': isMobileScreen}" id="right-player">
              ...
              <div v-else-if="isVideoSource(re) && !isDataLoading" class="d-flex">
                ...
                <video @mouseover="videoHoverIn(re, le, false)" id="right-video-player" v-else width="100%" :height="elementHeight" loop autoplay controls playsinline :src="re.source_url"></video>
              </div>
