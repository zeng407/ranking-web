...
return [
    ...
    */
    ...
    'google_ad' => [
        ...
        'game_page_ad_3_slot' => env('GOOGLE_AD_GAME_PAGE_AD_3_SLOT', ''),
        'game_page_ad_4_slot' => env('GOOGLE_AD_GAME_PAGE_AD_4_SLOT', ''),
        'home_page' => env('GOOGLE_AD_HOME_PAGE', false),
        'home_page_ad_1_slot' => env('GOOGLE_AD_HOME_PAGE_AD_1_SLOT', ''),
        'home_page_ad_top_slot' => env('GOOGLE_AD_HOME_PAGE_AD_TOP_SLOT', ''),
        'home_page_champion_top_slot' => env('GOOGLE_AD_HOME_PAGE_CHAMPION_TOP_SLOT', ''),
        'home_page_champion_bottom_slot' => env('GOOGLE_AD_HOME_PAGE_CHAMPION_BOTTOM_SLOT', ''),
